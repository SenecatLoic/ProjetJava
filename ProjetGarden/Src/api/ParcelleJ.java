...
public class ParcelleJ implements Parcelle{
    ...
    public static void main(String[] args) {
        ...
        // ou bien utiliser Junit dans une autre classe.
         ...
         ParcelleJ p0 = new ParcelleJ("Eden", 600, 400);
         p0.SplitParcelle(Orientation.HORIZONTAL);
         ParcelleJ p00 = (ParcelleJ)p0.getFirst();
         ParcelleJ p01 = (ParcelleJ)p0.getSecond();
         p00.SplitParcelle(Orientation.VERTICAL);
         ParcelleJ p001 =(ParcelleJ)p00.getSecond();
         ParcelleJ p002 =(ParcelleJ)p00.getFirst();
         p002.SplitParcelle(Orientation.VERTICAL);
         /*p01.SplitParcelle(Orientation.HORIZONTAL);
         ParcelleJ p010 = (ParcelleJ)p01.getFirst();*/
        
         LocalDate now = LocalDate.now();

        /* Fenetre fenetre = new Fenetre();

         JardinPanel jp = new JardinPanel(p0);
        ...
        Iterator <Action> it =p00.getAllActions();

        while(it.hasNext()){
            //System.out.println(p0.actions.it.next());
